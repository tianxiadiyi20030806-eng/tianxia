...
📘 [**AI 应用开发学习手册**](docs/学习手册.md) ｜ [PDF 版](docs/学习手册.pdf)（25 页）

从零到能投简历的完整学习记录，包含：

- **知识体系**：Agent 基础 → RAG 全链路 → MCP 协议 → 服务化 → 框架与工程化
- **踩坑录**：14 个真实踩过的坑（PDF 提取、分词、代理变量、git 配置……）
- **核心概念速查表**：Python↔C 对照、关键数字、大模型应用概念
- **面试问答准备**：7 个高频问题的完整回答

**转换脚本**：`python3 docs/md2pdf.py docs/学习手册.md`（markdown → HTML → PDF）
